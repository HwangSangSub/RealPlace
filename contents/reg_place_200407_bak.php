...
if($total_cnt < 301){
	if ($reg_Id != "") {
		...
		if($con_Idx != ""){
			...
			//핀 등록
			$query = "INSERT INTO TB_PLACE (member_Idx, category, place_Name, place_Icon, memo, smemo, tel, img, otime_Day, otime_Week, addr, lng, lat, open_Bit, reg_Id, mod_Date, reg_date) VALUES (:member_Idx, :category, :place_Name, :place_Icon, :memo, :smemo, :tel, '', :otime_Day, :otime_Week, :addr, :lng, :lat, :open_Bit, :reg_Id, NOW(), :reg_Date)";

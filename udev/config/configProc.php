<?
	...
	if ($mode == "reg") {
		...
		$insQuery = "INSERT INTO TB_CONFIG (con_SharingD, con_SharingS, con_ETime, con_FTime, con_Distance, con_MaxDc, con_Sec, con_GpsTime, con_GpsPTime, con_GpsYTime, con_GpsRegTime, con_BtnTime, con_OrdFCnt, con_mTxt, con_PopupChk, con_PopupUrl, conComp1_Max_D, conComp1_H, conComp2_Min_D, conComp2_Max_D, conComp2_H, conComp3_Min_D, conComp3_Max_D, conComp3_H, conComp4_Min_D, conComp4_H, conRecom_RC, conRecom_RP, conRecom_BRC, conRecom_BRP ) VALUES (:con_SharingD, :con_SharingS, :con_ETime, :con_FTime, :con_Distance, :con_MaxDc, :con_Sec, :con_GpsTime, :con_GpsPTime, :con_GpsYTime, :con_GpsRegTime, :con_BtnTime, con_OrdFCnt, :con_mTxt, :con_PopupChk, :con_PopupUrl, :conComp1_Max_D, :conComp1_H, :conComp2_Min_D, :conComp2_Max_D, :conComp2_H, :conComp3_Min_D, :conComp3_Max_D, :conComp3_H, :conComp4_Min_D, :conComp4_H, :conRecom_RC, :conRecom_RP, :conRecom_BRC, :conRecom_BRP )";
		...
		$stmt->bindParam(":con_FTime", $con_FTime);
		...
		$stmt->bindParam(":con_OrdFCnt", $con_OrdFCnt);

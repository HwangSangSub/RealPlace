			...
			<tr>
				...
				<td colspan="3">
					...
					*/
					...
					{
					?>
					<img src="/data/guide/photo.php?id=<? echo $con_GuideUrl1?>" style="height:100px">
					<input type="checkbox" id="del_guide_Img1" name="del_guide_Img1" value="1">삭제
					<?
					}
					?>
			...
			<tr>
				...
				<td colspan="3">
					...
					*/
					...
					{
					?>
					<img src="/data/guide/photo.php?id=<? echo $con_GuideUrl2?>" style="height:100px">
					<input type="checkbox" id="del_guide_Img2" name="del_guide_Img2" value="1">삭제
					<?
					}
			...
			<tr>
				...
				<td colspan="3">
					...
					*/
					...
					{
					?>
					<img src="/data/guide/photo.php?id=<? echo $con_GuideUrl3?>" style="height:100px">
					<input type="checkbox" id="del_guide_Img3" name="del_guide_Img3" value="1">삭제
					<?
					}
			...
			<tr>
				...
				<td colspan="3">
					...
					*/
					...
					{
					?>
					<img src="/data/guide/photo.php?id=<? echo $con_GuideUrl4?>" style="height:100px">
					<input type="checkbox" id="del_guide_Img4" name="del_guide_Img4" value="1">삭제
					<?
					}
			...
			<tr>
				...
				<td colspan="3">
					...
					*/
					...
					{
					?>
					<img src="/data/guide/photo.php?id=<? echo $con_GuideUrl5?>" style="height:100px">
					<input type="checkbox" id="del_guide_Img5" name="del_guide_Img5" value="1">삭제
					<?
					}

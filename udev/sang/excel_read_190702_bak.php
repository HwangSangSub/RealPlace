...
if($chklistnum < 1){
	$listquery = "
			INSERT INTO TB_EXCELDATA_LIST (mem_Id, mem_Idx, f_Name, u_Date, reg_Date)
	...
	try {
		...
		for ($i = 1 ; $i <= $maxRow; $i++) {
			...
			$query = "
					INSERT INTO TB_EXCELDATA (mem_Id, mem_Idx, e_Date, e_Time, e_State, Manager, p_Date, p_Manager, p_Time, c_No, c_Name, car_No, p_Name, b_No, d_Distance, c_Distance, r_Date, p_Tel, h_Tel, z_Code, n_Addr, p_Addr, d_Addr, Lng, Lat, o_State, f_Name, reg_Date)

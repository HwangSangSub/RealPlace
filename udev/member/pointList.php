<?
	...
	if($mode == "detail")
	{
		...
		$titNm = "<a href='memberReg.php?mode=mod&id=".$id."'><span style='color:blue'>".$id."(".$sqlRow['mem_NickNm'].")</span></a>님의 캐시상세내역보기";
	}
	else
	{
		$titNm = "캐시관리";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<? if ($mode != "detail"){ ?>
		<th scope="col" id="mb_list_auth">캐시내역</th> 
		<? } ?>
    ...
    <tr class="<?=$bg?>" title="<?=$taxi_Memo?>">
		...
		<? if ($mode != "detail"){ ?>
		<td headers="mb_list_point"><a href="pointList.php?mode=detail&id=<?=$memId?>">내역보기</a></td> 
		<? } ?>
...
<div class="btn_fixed_top">	
	<a href="pointReg.php?mode=reg" id="bt_m_a_add" class="btn btn_01">캐시등록</a>
</div>

<?
	...
	$sql_search=" WHERE 1 AND code_Div = 'report'";
...
<div id="wrapper">
    <div id="container" class="">
        ...
        <h1 id="container_title">신고코드관리</h1>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_code_idx">신고코드</th>
        <th scope="col" id="mb_list_code_n">신고사유</th>
    ...
    <tr class="<?=$bg?>">
        ...
        <td headers="mb_list_id"><?=$code?></td>
        <td headers="mb_list_id"><?=$code_Name?></td>
        <td headers="mb_list_id"><?=$use_Bit?></td>
        <td headers="mb_list_id"><?=$reg_Date?></td>
		<td headers="mb_list_mng" class="td_mng td_mng_s"><a href="report_reg.php?mode=mod&idx=<?=$idx?>&<?=$qstr?>&page=<?=$page?>" class="btn btn_03">수정</a><a href="javascript:chkDel('<?=$idx?>')" class="btn btn_02">삭제</a>
		</td>
    </tr>
    <? 
...
<div class="btn_fixed_top">
	<a href="report_reg.php" id="config_add" class="btn btn_01">등록</a> 
</div>

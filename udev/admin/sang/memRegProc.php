...
if ($mem_Id != "") {
    ...
    if($num < 1)  { //주 ID가 없을 경우 회원가입 시작       
		...
		//회원 기본테이블 저장
		$insQuery = "INSERT INTO TB_MEMBERS (mem_Id, mem_Nm, mem_Pwd, mem_Tel, mem_CertBit, mem_Birth, mem_Lv, b_Disply, use_Date, reg_Date ) VALUES (:mem_Id, :mem_Nm, :mem_Pwd, :mem_Tel, '0', '', :mem_Lv, :b_Disply, :use_Date, :reg_Date)";
